    ...
    public class PDSCarDamage : PDSExport<PacketCarDamageData>
    {
        public override void ExportToPds(PacketCarDamageData packetData, string filePath)
        {
            using (StreamWriter writer = new StreamWriter(filePath))
            {
                ...
                writer.WriteLine("# Columns: Car Index, Tyres Wear (FL, FR, RL, RR), Tyres Damage (FL, FR, RL, RR), Brakes Damage (FL, FR, RL, RR), " +
                                    "Front Left Wing Damage, Front Right Wing Damage, Rear Wing Damage, Floor Damage, Diffuser Damage, Sidepod Damage, " +
                                    "DRS Fault, ERS Fault, Gearbox Damage, Engine Damage, Engine MGU-H Wear, Engine ES Wear, Engine CE Wear, Engine ICE Wear, " +
                                    "Engine MGU-K Wear, Engine TC Wear, Engine Blown, Engine Seized");
