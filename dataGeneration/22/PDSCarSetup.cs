        ...
        public override void ExportToPds(PacketCarSetupData packetData, string filePath)
        {
            using (StreamWriter writer = new StreamWriter(filePath))
            {
                ...
                writer.WriteLine("# Columns: Car Index, Front Wing, Rear Wing, On Throttle, Off Throttle, Front Camber, Rear Camber, Front Toe, " +
                                    ...
                                    "Rear Suspension Height, Brake Pressure, Brake Bias, Front Left Tyre Pressure, Front Right Tyre Pressure, " +
                                    "Rear Left Tyre Pressure, Rear Right Tyre Pressure, Ballast, Fuel Load");
