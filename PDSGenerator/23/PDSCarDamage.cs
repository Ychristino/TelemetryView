        ...
        public override void ExportPdsHeader(string filePath)
        {
            using (StreamWriter writer = new StreamWriter(filePath, append: true))
            {
                ...
                writer.WriteLine("# Columns: Car Index, Front Left Wing Damage, Front Right Wing Damage, " +
                                    ...
                                    "Tyre Wear RL, Tyre Wear RR, Tyre Wear FL, Tyre Wear FR, " +
                                    "Tyre Damage RL, Tyre Damage RR, Tyre Damage FL, Tyre Damage FR, " +
                                    "Brake Damage RL, Brake Damage RR, Brake Damage FL, Brake Damage FR");
            }
        }
