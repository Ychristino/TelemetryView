...
{
    public class PDSFinalClassification : PDSExport<PacketFinalClassification>
    {
        public override void ExportPdsHeader(string filePath)
        {
            using (StreamWriter writer = new StreamWriter(filePath, append: true))
            {
                ...
                writer.WriteLine("# Columns: Position, Grid Position, Laps, Points, Pit Stops, Result Status, Best Lap Time, " +
                                 "Total Race Time, Penalties Time, Number of Penalties, Number of Tyre Stints, Tyre Stints Actual, " +
                                 "Tyre Stints Visual, Tyre Stints End Laps");
            }
        }
        public override void ExportToPds(PacketFinalClassification packetData, string filePath)
        {
            using (StreamWriter writer = new StreamWriter(filePath, append: true))
            {
