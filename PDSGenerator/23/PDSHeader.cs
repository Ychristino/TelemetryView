    ...
    public class PDSHeader : PDSExport<PacketHeader>
    {
        public override void ExportPdsHeader(string filePath)
        {
            using (StreamWriter writer = new StreamWriter(filePath, append: true))
            {
                ...
                writer.WriteLine("# Columns: Packet Format, Game Year, Game Version (Major.Minor), Packet Version, Packet ID, " +
                                 "Session UID, Session Time, Frame Identifier, Overall Frame Identifier, Player Car Index, Secondary Player Car Index");
            }
        }
