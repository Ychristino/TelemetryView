    ...
    public class PDSHeader : PDSExport<PacketHeader> // Herda de PDSExport<PacketHeader>
    {
        public override void ExportPdsHeader(string filePath)
        {
            using (StreamWriter writer = new StreamWriter(filePath, append: true))
            {
                ...
                writer.WriteLine("# Columns: Packet Format, Game Version, Packet Version, Packet ID, Session UID, " +
                                 "Session Time, Frame Identifier, Player Car Index, Secondary Player Car Index");
            }
        }
