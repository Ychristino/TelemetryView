...
{
    public class PDSFinalClassification : PDSExport<PacketFinalClassification> // Herda de PDSExport<PacketFinalClassificationData>
    {
        ...
        public override void ExportToPds(PacketFinalClassification classificationData, string filePath)
        {
            using (StreamWriter writer = new StreamWriter(filePath, append: true))
            {
