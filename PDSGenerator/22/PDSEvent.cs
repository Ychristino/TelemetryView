...
using System.IO;
using TelemetryViewer.Dicts.f122.Buttons;
using TelemetryViewer.Dicts.f122.Infringements;
using TelemetryViewer.Dicts.f122.Penalties;
                ...
                if (packetData.m_eventStringCode != null)
                {
                    ...
                    switch (eventType)
                    {
                        ...
                        case "Buttons":
                            ...
                            writer.WriteLine(string.Format(CultureInfo.InvariantCulture,
                                "Buttons, , , , , , , , , , , , {0}, ",
                                Button.GetPressedButtons(buttons.m_buttonStatus)));
                            break;
